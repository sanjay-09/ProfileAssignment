    ...
    return (
        <>
            ...
            <div className="flex flex-col">
                ...
                <div className='flex p-6 shadow-xl rounded-md m-2 bg-white justify-around gap-2 '>
                    <img src={selectedProduct.img} className='rounded-xl border cursor-pointer w-[200px] h-[300px]'  />
                    <div className='flex flex-col gap-24 justify-center'>
                        <div className='line-clamp-10 '>
                            <a className='text-black text-3xl font-bold hover:underline' href={"https://google.com"}>{selectedProduct.title} X {selectedProduct.quantity}</a>
                            <p className='mt-4 text-[20px]'>{selectedProduct.category}</p>
                        </div>
                        <div className='flex gap-6 text-lg'>
                            <h3 className='font-extrabold text-4xl'>$ {selectedProduct.newPrice}</h3>
